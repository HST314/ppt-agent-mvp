...
import { badge, button, element, field, metadataList, previewFrame, previewUrl, shortHash, versionTimeline } from "../components/index.js?v=2026.08.23.100340566066";
...
export async function render(context) {
  const [view, planning] = await Promise.all([
    context.authoritativeView || api.samples(context.taskId, context.controller),
