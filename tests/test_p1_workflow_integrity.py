...
class StateAndEvidenceIntegrityTests(unittest.TestCase):
    ...
    def test_duplicate_model_and_browser_issue_keeps_both_resolvable_sources(self):
        with tempfile.TemporaryDirectory() as root:
            ...
            issue = next(item for item in view["report"]["issues"] if item["issue_id"] == "shared-overflow")
